...
TEMPLATES = dict(
    main='seq_template.html',
    gene='seq_gene_template.html',
    strain='seq_strain_template.html',
    reads='seq_read_align_template.html',
    mutation='seq_mutation_template.html'
)
CSS_FILE = 'mutantanalysis.css'
BASE_CSS_FILE = 'reset-fonts-grids.css'  # Yahoo API. May need to update.
TABBED_OUTPUT = 'tabbed_output.txt'
MUTATION_OUTPUT = 'mutation_output.txt'
